...
def get_data_from_api_and_insert_to_mongo():
    query_payload = {
        'size': 6000,
        'page': 1,
...
with DAG(
    dag_id='sales_analytic_mongo_dag',
    ...
    task_get_data_from_api_and_insert_to_mongo = PythonOperator(
        task_id='get_data_from_api_and_insert_to_mongo',
        python_callable=get_data_from_api_and_insert_to_mongo
    )
...
task_start >> task_send_line_notify_start >> task_get_data_from_api_and_insert_to_mongo >> task_sent_line_notify_end >> task_end
